...
#     update_total()
# def reset_nomor():
#     for i, child in enumerate(tree.get_children(), start=1):
#         values = list(tree.item(child)["values"])
#         values[0] = i  # Kolom No ada di indeks 0
...
# style.configure("Treeview", borderwidth=1, relief="solid", highlightthickness=1)

# # Frame untuk total dan tombol tambah di baris atas
# top_frame = tk.Frame(root)
# top_frame.pack(pady=(10, 0), fill="x", padx=10)

# total_label = tk.Label(top_frame, text="Total: Rp0", font=("Arial", 14))
# total_label.pack(side="left")

# btn_tambah = tk.Button(top_frame, text="Tambah", font=("Arial", 12), command=tambah_baris, bg="lightgreen")
# btn_tambah.pack(side="right")


# # Tabel Treeview
# tree = ttk.Treeview(root, columns=("No", "Nama", "Jumlah", "Harga", "Total", "Hapus"), show="headings", height=12)
# tree.heading("No", text="No")
# tree.heading("Nama", text="Nama Barang")
# tree.heading("Jumlah", text="Jumlah")
# tree.heading("Harga", text="Harga")
